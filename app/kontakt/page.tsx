    ...
    return (
      <main className="flex flex-col items-center mx-16 text-white">
       ...
       <span className="p-2">Mail på: <a className="underline hover:text-ligth_teal text-teal" href="mailto:post@variant.no">post@variant.no</a>
         ...
         <span className="p-2">Bilder på: <a className="underline hover:text-ligth_teal text-teal" href="https://instagram.com/variant_as" aria-label="Instagram @variant_as" rel="noopener">@variant_as</a>
       </span>
